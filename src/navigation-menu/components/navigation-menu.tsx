import { AddressIcon } from '~/shared/assets/address-icon'
import { DashboardIcon } from '../../shared/assets/dashboard-icon'
import { ContactIcon } from '~/shared/assets/contact-icon'
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-zinc-50 space-y-11">
          <div className="text-4xl font-bold">
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg">
              <span className="ml-3">GetCloser</span>
            </a>
          </div>

          <ul className="space-y-11 font-medium">
